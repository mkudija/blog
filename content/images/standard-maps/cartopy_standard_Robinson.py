...
def main():
    ...
    # grey
    title = 'maps/world_Robinson_grey.png'
    ...
    title = 'maps/world_Robinson_blue.png'
    plt.savefig(title, bbox_inches='tight', pad_inches=.2, dpi=300)
    print('Saved: {}'.format(title))
    ...
    title = 'maps/world_Robinson_blue_countries.png'
    plt.savefig(title, bbox_inches='tight', pad_inches=.2, dpi=300)
    print('Saved: {}'.format(title))
    ...
    ax.add_feature(cartopy.feature.BORDERS, edgecolor='white', linewidth=.25)
    title = 'maps/world_Robinson_grey_countries.png'
    plt.savefig(title, bbox_inches='tight', pad_inches=.2, dpi=300)
    print('Saved: {}'.format(title))

...
<!-- ![alt]({filename}/images/country-maps/maps/EU-Members.png) -->
...
Define which countries to highlight in [**`countries.csv`**](../images/country-maps/countries.csv). The script below 
